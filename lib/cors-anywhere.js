...
function getHandler(options, proxy) {
  ...
  // Add Authorization header if URL includes api.themoviedb.org
  if (location.host.includes('api.themoviedb.org')) {
    ...
    // Check if the origin contains the allowed domain
    if (!origin.includes('site.example.com') && !origin.includes('site-test.example.com')) {
      res.writeHead(429, 'Forbidden', {
